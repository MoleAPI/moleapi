...
func Setup2FA(c *gin.Context) {
	...
	// 记录操作日志
	model.RecordLogWithQuotaAndOperation(userId, model.LogTypeSystem, "开始设置两步验证", 0, "user.2fa_setup_started", nil)
...
func Enable2FA(c *gin.Context) {
	...
	// 记录操作日志
	model.RecordLogWithQuotaAndOperation(userId, model.LogTypeSystem, "成功启用两步验证", 0, "user.2fa_enabled", nil)
...
func Disable2FA(c *gin.Context) {
	...
	// 记录操作日志
	model.RecordLogWithQuotaAndOperation(userId, model.LogTypeSystem, "禁用两步验证", 0, "user.2fa_disabled", nil)
...
func RegenerateBackupCodes(c *gin.Context) {
	...
	// 记录操作日志
	model.RecordLogWithQuotaAndOperation(userId, model.LogTypeSystem, "重新生成两步验证备用码", 0, "user.2fa_backup_codes_regenerated", nil)
