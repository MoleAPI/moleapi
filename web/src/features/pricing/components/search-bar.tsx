      ...
      <div className='relative'>
        ...
        <input
          ...
          className={cn(
            ...
            'h-11 w-full rounded-lg border pr-20 pl-11 text-sm transition-all outline-none'
          )}
          aria-label={t('Search models')}
        />
        <div className='absolute top-1/2 right-3.5 flex -translate-y-1/2 items-center gap-1'>
          {props.value ? (
            <Button
              variant='ghost'
              size='icon'
