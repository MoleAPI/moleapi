  ...
  test.each(['cold', 'stale'] as const)(
    ...
    async (cacheState) => {
      ...
      const status = {
        system_name: 'shared',
        HeaderNavModules: {
          pricing: { enabled: true, requireAuth: true, adminOnly: false },
      ...
      expect(await guards).toEqual([
        { enabled: true, requireAuth: true, adminOnly: false },
...
describe('module guard status freshness', () => {
  test.each([
    {
      module: 'pricing',
      before: { enabled: false, requireAuth: false, adminOnly: false },
      after: { enabled: true, requireAuth: false, adminOnly: false },
    },
    {
      module: 'rankings',
      before: { enabled: true, requireAuth: false, adminOnly: false },
      after: { enabled: false, requireAuth: false, adminOnly: false },
    },
    {
      module: 'pricing',
      before: { enabled: true, requireAuth: false, adminOnly: false },
      after: { enabled: true, requireAuth: true, adminOnly: false },
    },
    {
      module: 'rankings',
      before: { enabled: true, requireAuth: true, adminOnly: false },
      after: { enabled: true, requireAuth: false, adminOnly: false },
    },
