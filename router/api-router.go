...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/lantu/notify", anonymousRequestBodyLimit, controller.LanTuPayNotify)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/aff/history", middleware.SearchRateLimit(), controller.GetInviteRebateTopUps)
				...
				selfRoute.POST("/lantu/pay", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, controller.RequestLanTuPay)
				selfRoute.GET("/lantu/status", controller.GetLanTuOrderStatus)
				selfRoute.POST("/nowpayments/amount", anonymousRequestBodyLimit, controller.RequestNowPaymentsAmount)
				selfRoute.POST("/nowpayments/pay", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, controller.RequestNowPaymentsPay)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/topup/complete", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, controller.AdminCompleteTopUp)
				adminRoute.GET("/search", controller.SearchUsers)
				adminRoute.POST("/invite_rebate/apply_default", controller.ApplyDefaultInviteRebateRatio)
				adminRoute.GET("/invite_rebate/ratios", controller.ListInviteRebateRatios)
				adminRoute.POST("/invite_rebate/batch_update", controller.BatchUpdateInviteRebateRatio)
				adminRoute.GET("/:id/oauth/bindings", controller.GetUserOAuthBindingsByAdmin)
				adminRoute.DELETE("/:id/oauth/bindings/:provider_id", controller.UnbindCustomOAuthByAdmin)
				adminRoute.DELETE("/:id/bindings/:binding_type", controller.AdminClearUserBinding)
				adminRoute.GET("/:id", controller.GetUser)
				adminRoute.POST("/", controller.CreateUser)
				adminRoute.POST("/manage", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, controller.ManageUser)
		...
		dataRoute.GET("/channel-success", middleware.AdminAuth(), controller.GetChannelSuccessMetrics)
		dataRoute.GET("/business", middleware.AdminAuth(), controller.GetAdminBusinessMetrics)
		...
		modelsRoute.Use(middleware.AdminAuth())
		{
			...
			modelsRoute.GET("/descriptions/export", controller.ExportModelDescriptions)
			modelsRoute.POST("/descriptions/import", controller.ImportModelDescriptions)
