...
type QuotaData struct {
	...
	// ponytail: these reporting dimensions are not filtered alone, so avoid four costly single-column indexes on existing large tables.
	UseGroup  string `json:"use_group" gorm:"size:64;default:''"`
